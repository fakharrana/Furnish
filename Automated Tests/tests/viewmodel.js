...
module.exports.viewmodel = async function () {
  ...
  try {
    ...
    await driver.wait(until.elementLocated(By.id("view-model-button-1")));
    await driver.findElement(By.id("view-model-button-1")).click();
  } catch (error) {
