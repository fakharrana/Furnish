...
module.exports.analyzereviews = async function () {
  ...
  try {
    ...
    await driver.wait(until.elementLocated(By.id("analyze-reviews-button")));
    await driver.findElement(By.id("analyze-reviews-button")).click();
  } catch (error) {
