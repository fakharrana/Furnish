...
module.exports.filterproductsbycategory = async function () {
  ...
  try {
    ...
    await driver.wait(until.elementLocated(By.id("filter-by-category")));
    await driver.findElement(By.id("filter-by-category")).sendKeys("Bed");
  } catch (error) {
