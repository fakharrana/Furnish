...
module.exports.deletecustomer = async function () {
  ...
  try {
    ...
    await driver.wait(until.elementLocated(By.id("delete-customer-button-1")));
    await driver.findElement(By.id("delete-customer-button-1")).click();
